...
int testFragmentize() {
  ...
  const FragmentTerm terms[] = {SCORED_TERM("adam", 1.5), SCORED_TERM("eve", 2),
  ...
  FragmentList_Init(&fragList, terms, nterms, NULL, 8, 6);
